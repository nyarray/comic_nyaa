...
class NyaaDownloadManager {
  ...
  static FutureOr<NyaaDownloadManager> get instance async {
  ...
  FutureOr<void> add(TypedModel item) async {
  ...
  FutureOr<void> addAll(Iterable<TypedModel> items) async {
    final downloadDir = await AppConfig.downloadDir;
    final downloadLevel =
        (await AppPreferences.instance).downloadResourceLevel;
  ...
  FutureOr<void> delete(NyaaDownloadTaskQueue item) async {
    item.pause();
