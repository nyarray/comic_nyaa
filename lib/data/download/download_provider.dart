...
class DownloadProvider  {
  ...
  FutureOr<DownloadProvider> open() async {
  ...
  FutureOr<int> insert(NyaaDownloadTaskQueue task) async {
  ...
  FutureOr<NyaaDownloadTaskQueue?> getTask(int id) async {
  ...
  FutureOr<List<NyaaDownloadTaskQueue>> getTasks() async {
